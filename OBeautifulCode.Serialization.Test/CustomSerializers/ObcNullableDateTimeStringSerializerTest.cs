// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ObcNullableDateTimeStringSerializerTest.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.Serialization.Test
{
    ...
    public static class ObcNullableDateTimeStringSerializerTest
    {
        [Fact]
        ...
        [Fact]
        public static void Deserialize_T___Should_throw_ArgumentException___When_type_parameter_is_not_Nullable_DateTime()
        {
            // Arrange
            var systemUnderTest = new ObcNullableDateTimeStringSerializer();
        ...
        public static void Deserialize_T___Should_deserialize_UTC_DateTime___When_serialized_strings_have_reduced_precision()
        {
            ...
            var expected = serializedDateTimes.Select(_ => DateTime.Parse(_, CultureInfo.InvariantCulture, DateTimeStyles.AssumeUniversal | DateTimeStyles.AdjustToUniversal)).Cast<DateTime?>().ToList();
        ...
        {
            // Arrange
            DateTime? expected = TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("GMT Standard Time"));
            var serializer = new ObcNullableDateTimeStringSerializer();
        ...
        {
            // Arrange
            DateTime? expected = TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("New Zealand Standard Time"));
            var serializer = new ObcNullableDateTimeStringSerializer();

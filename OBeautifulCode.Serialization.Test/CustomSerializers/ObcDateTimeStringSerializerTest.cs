...
namespace OBeautifulCode.Serialization.Test
{
    ...
    public static class ObcDateTimeStringSerializerTest
    {
        ...
        public static void SerializeToString_object___Should_throw_ArgumentException___When_parameter_value_is_not_DateTime()
        {
            ...
            var values = new object[] { new object(), A.Dummy<string>(), A.Dummy<int>(), A.Dummy<Guid>() };
        ...
        public static void Deserialize_T___Should_throw_ArgumentException___When_type_parameter_is_not_DateTime()
        {
            ...
            // Act
            var actual = Record.Exception(() => systemUnderTest.Deserialize<object>("2019-01-05T12:14:58.1920000Z"));

            // Assert
            actual.Must().BeOfType<ArgumentOutOfRangeException>();
            actual.Message.Must().ContainString("System.DateTime");
            actual.Message.Must().ContainString("name: 'type'");
        }
        ...
        public static void Deserialize_serializedString_type___Should_throw_ArgumentException___When_parameter_type_is_not_DateTime()
        {
            ...
            // Act
            var actual = Record.Exception(() => systemUnderTest.Deserialize("2019-01-05T12:14:58.1920000Z", typeof(object)));

...
namespace OBeautifulCode.Serialization.Test
{
    ...
    public static class ObcJsonSerializerTest
    {
        ...
        public static void SerializeObject_without_type_serializes_to_json_using_DefaultSerializerSettings()
        {
            ...
            var json = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Animal>).ToJsonSerializationConfigurationType()).SerializeToString(dog);
        ...
        public static void DeserializeObject_with_type_deserialize_json_using_DefaultSerializerSettings()
        {
            ...
            var dog = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Animal>).ToJsonSerializationConfigurationType()).Deserialize(dogJson, typeof(Animal)) as Dog;
        ...
        public static void SerializeObject_without_type_serializes_to_json_using_CompactSerializerSettings()
        {
            ...
            var json = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Animal>).ToJsonSerializationConfigurationType(), formattingKind: JsonFormattingKind.Compact).SerializeToString(dog);
        ...
        public static void DeserializeObjectOfT_deserialize_json_using_CompactSerializerSettings()
        {
            ...
            var dog = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Animal>).ToJsonSerializationConfigurationType(), formattingKind: JsonFormattingKind.Compact).Deserialize<Animal>(dogJson) as Dog;
        ...
        public static void DeserializeObject_with_type_deserialize_json_using_CompactSerializerSettings()
        {
            ...
            var dog = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Animal>).ToJsonSerializationConfigurationType(), formattingKind: JsonFormattingKind.Compact).Deserialize(dogJson, typeof(Animal)) as Dog;
        ...
        public static void DeserializeObject_without_type_deserialize_json_into_JObject_using_CompactSerializerSettings()
        {
            ...
            var dog = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Animal>).ToJsonSerializationConfigurationType(), UnregisteredTypeEncounteredStrategy.Attempt, JsonFormattingKind.Compact).Deserialize<dynamic>(dogJson) as JObject;
        ...
        public static void SerializeObject_without_type_serializes_to_json_using_MinimalSerializerSettings()
        {
            ...
            var json = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Animal>).ToJsonSerializationConfigurationType(), formattingKind: JsonFormattingKind.Minimal).SerializeToString(dog);
        ...
        public static void DeserializeObjectOfT_deserialize_json_using_MinimalSerializerSettings()
        {
            ...
            var lighting = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Lighting>).ToJsonSerializationConfigurationType(), formattingKind: JsonFormattingKind.Minimal).Deserialize<Lighting>(lightingJson) as NoLighting;
        ...
        public static void DeserializeObject_with_type_deserialize_json_using_MinimalSerializerSettings()
        {
            ...
            var lighting = new ObcJsonSerializer(typeof(RegisterOnlyWithDiscoveryJsonSerializationConfiguration<Lighting>).ToJsonSerializationConfigurationType(), formattingKind: JsonFormattingKind.Minimal).Deserialize(lightingJson, typeof(Lighting)) as NoLighting;

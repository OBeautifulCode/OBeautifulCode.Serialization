...
namespace OBeautifulCode.Serialization.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NullDescribedSerialization> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NullDescribedSerialization>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<NullDescribedSerialization>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<NullDescribedSerialization>();

                        var result = new SystemUnderTestExpectedStringRepresentation<NullDescribedSerialization>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.Serialization.NullDescribedSerialization: PayloadTypeRepresentation = {systemUnderTest.PayloadTypeRepresentation?.ToString() ?? "<null>"}, SerializerRepresentation = {systemUnderTest.SerializerRepresentation?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NullDescribedSerialization> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NullDescribedSerialization>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<NullDescribedSerialization> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NullDescribedSerialization>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NullDescribedSerialization>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<NullDescribedSerialization>
                        {
                            SystemUnderTest = new NullDescribedSerialization(
                                                      referenceObject.PayloadTypeRepresentation,
                                                      referenceObject.SerializerRepresentation),
        ...
        private static readonly DeepCloneWithTestScenarios<NullDescribedSerialization> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<NullDescribedSerialization>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NullDescribedSerialization>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NullDescribedSerialization>().ThatIs(_ => !systemUnderTest.PayloadTypeRepresentation.IsEqualTo(_.PayloadTypeRepresentation));

                        var result = new SystemUnderTestDeepCloneWithValue<NullDescribedSerialization>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NullDescribedSerialization>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NullDescribedSerialization>().ThatIs(_ => !systemUnderTest.SerializerRepresentation.IsEqualTo(_.SerializerRepresentation));
        ...
        private static readonly NullDescribedSerialization ReferenceObjectForEquatableTestScenarios = A.Dummy<NullDescribedSerialization>();

        private static readonly EquatableTestScenarios<NullDescribedSerialization> EquatableTestScenarios = new EquatableTestScenarios<NullDescribedSerialization>()
            .AddScenario(() =>
                new EquatableTestScenario<NullDescribedSerialization>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NullDescribedSerialization[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new NullDescribedSerialization[]
                    {
                        new NullDescribedSerialization(
                                A.Dummy<NullDescribedSerialization>().Whose(_ => !_.PayloadTypeRepresentation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.PayloadTypeRepresentation)).PayloadTypeRepresentation,
                                ReferenceObjectForEquatableTestScenarios.SerializerRepresentation),
                        new NullDescribedSerialization(
                                ReferenceObjectForEquatableTestScenarios.PayloadTypeRepresentation,
                                A.Dummy<NullDescribedSerialization>().Whose(_ => !_.SerializerRepresentation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SerializerRepresentation)).SerializerRepresentation),
                    },
        ...
        public static class Structural
        {
            ...
            public static void NullDescribedSerialization___Should_implement_IModel_of_NullDescribedSerialization___When_reflecting()
            {
                // Arrange
                var type = typeof(NullDescribedSerialization);

                var expectedModelMethods = typeof(IModel<NullDescribedSerialization>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NullDescribedSerialization>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NullDescribedSerialization___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NullDescribedSerialization);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NullDescribedSerialization)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.PayloadTypeRepresentation.GetType().IsValueType)
                {
            ...
            {
                var propertyNames = new string[] { "PayloadTypeRepresentation", "SerializerRepresentation" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NullDescribedSerialization)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(NullDescribedSerialization).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                NullDescribedSerialization systemUnderTest1 = null;
                NullDescribedSerialization systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    NullDescribedSerialization systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullDescribedSerialization___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullDescribedSerialization___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullDescribedSerialization___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullDescribedSerialization___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullDescribedSerialization___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();

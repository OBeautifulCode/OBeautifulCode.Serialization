    ...
    public static partial class SerializerDescriptionTest
    {
                ...
                new StringRepresentationTestScenario<SerializerDescription>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<SerializerDescription>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.Serialization.SerializerDescription: SerializationKind = {systemUnderTest.SerializationKind.ToString() ?? "<null>"}, SerializationFormat = {systemUnderTest.SerializationFormat.ToString() ?? "<null>"}, CompressionKind = {systemUnderTest.CompressionKind.ToString() ?? "<null>"}, ConfigurationTypeRepresentation = {systemUnderTest.ConfigurationTypeRepresentation?.ToString() ?? "<null>"}, Metadata = {systemUnderTest.Metadata?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SerializerDescription> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SerializerDescription>()
            .AddScenario(() =>
                ...
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'configurationTypeRepresentation' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "configurationTypeRepresentation" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SerializerDescription>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<SerializerDescription> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SerializerDescription>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SerializerDescription>
                {
                    ...
                    PropertyGetterFunc = systemUnderTest => systemUnderTest.SerializationKind,
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SerializerDescription>
                {
                    ...
                    PropertyGetterFunc = systemUnderTest => systemUnderTest.SerializationFormat,
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SerializerDescription>
                {
                    Name = "ConfigurationTypeRepresentation should return same 'configurationTypeRepresentation' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<SerializerDescription>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<SerializerDescription>
                        {
                            SystemUnderTest = new SerializerDescription(
                                                      ...
                                                      referenceObject.CompressionKind,
                                                      referenceObject.Metadata),
                            ExpectedPropertyValue = referenceObject.ConfigurationTypeRepresentation,
                        };

                        return result;
                    },
                    PropertyGetterFunc = systemUnderTest => systemUnderTest.ConfigurationTypeRepresentation,
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SerializerDescription>
                {
                    ...
                    PropertyGetterFunc = systemUnderTest => systemUnderTest.CompressionKind,
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SerializerDescription>
                {
                    ...
                    PropertyGetterFunc = systemUnderTest => systemUnderTest.Metadata,
                });
        ...
        private static readonly DeepCloneWithTestScenarios<SerializerDescription> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SerializerDescription>()
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SerializerDescription>
                {
                    Name = "DeepCloneWithConfigurationTypeRepresentation should deep clone object and replace ConfigurationTypeRepresentation with the provided configurationTypeRepresentation",
                    WithPropertyName = "ConfigurationTypeRepresentation",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SerializerDescription>();

                        var referenceObject = A.Dummy<SerializerDescription>().ThatIs(_ => !systemUnderTest.ConfigurationTypeRepresentation.IsEqualTo(_.ConfigurationTypeRepresentation));

                        var result = new SystemUnderTestDeepCloneWithValue<SerializerDescription>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ConfigurationTypeRepresentation,
                        };
                ...
                new EquatableTestScenario<SerializerDescription>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SerializerDescription[]
                    {
                        new SerializerDescription(
                                ...
                                ReferenceObjectForEquatableTestScenarios.ConfigurationTypeRepresentation,
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new SerializerDescription[]
                    {
                        ...
                        new SerializerDescription(
                                ReferenceObjectForEquatableTestScenarios.SerializationKind,
                                ReferenceObjectForEquatableTestScenarios.SerializationFormat,
                                A.Dummy<SerializerDescription>().Whose(_ => !_.ConfigurationTypeRepresentation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ConfigurationTypeRepresentation)).ConfigurationTypeRepresentation,
                                ReferenceObjectForEquatableTestScenarios.CompressionKind,
                                ReferenceObjectForEquatableTestScenarios.Metadata),
                        new SerializerDescription(
                                ReferenceObjectForEquatableTestScenarios.SerializationKind,
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                actual.AsTest().Must().BeEqualTo(systemUnderTest);
                actual.AsTest().Must().NotBeSameReferenceAs(systemUnderTest);
                actual.ConfigurationTypeRepresentation.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ConfigurationTypeRepresentation);
            ...
            {
                var propertyNames = new string[] { "SerializationKind", "SerializationFormat", "CompressionKind", "ConfigurationTypeRepresentation", "Metadata" };

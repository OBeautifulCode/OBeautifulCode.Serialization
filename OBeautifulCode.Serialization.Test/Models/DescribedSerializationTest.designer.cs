...
namespace OBeautifulCode.Serialization.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DescribedSerialization> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DescribedSerialization>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DescribedSerialization>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DescribedSerialization> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DescribedSerialization>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DescribedSerialization>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DescribedSerialization>().ThatIs(_ => !systemUnderTest.PayloadTypeRepresentation.IsEqualTo(_.PayloadTypeRepresentation));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DescribedSerialization>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DescribedSerialization>().ThatIs(_ => !systemUnderTest.SerializedPayload.IsEqualTo(_.SerializedPayload));
        ...
        private static readonly DescribedSerialization ReferenceObjectForEquatableTestScenarios = A.Dummy<DescribedSerialization>();

        private static readonly EquatableTestScenarios<DescribedSerialization> EquatableTestScenarios = new EquatableTestScenarios<DescribedSerialization>()
            .AddScenario(() =>
                new EquatableTestScenario<DescribedSerialization>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DescribedSerialization[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void DescribedSerialization___Should_implement_IModel_of_DescribedSerialization___When_reflecting()
            {
                // Arrange
                var type = typeof(DescribedSerialization);

                var expectedModelMethods = typeof(IModel<DescribedSerialization>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DescribedSerialization>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DescribedSerialization___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DescribedSerialization);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DescribedSerialization)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DescribedSerialization)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DescribedSerialization).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DescribedSerialization systemUnderTest1 = null;
                DescribedSerialization systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DescribedSerialization systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DescribedSerialization___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DescribedSerialization___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DescribedSerialization___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DescribedSerialization___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DescribedSerialization___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();

...
namespace OBeautifulCode.Serialization.Test
{
    ...
    public static class DirectStringSerializationIsSupported
    {
        ...
        {
            // Arrange
            var bsonSerializer = new ObcBsonSerializer<RegisterOnlyWithDiscoveryBsonSerializationConfiguration<string>>();
        ...
        {
            // Arrange
            var jsonSerializer = new ObcJsonSerializer<RegisterOnlyWithDiscoveryJsonSerializationConfiguration<string>>();
            var input = A.Dummy<string>();

...
namespace OBeautifulCode.Serialization.Json
{
    ...
    /// <summary>
    /// A JSON serialization configuration that populates <see cref="DependentJsonSerializationConfigurationTypes"/> with typeof(<typeparamref name="T"/>).
    /// </summary>
        ...
        where T : JsonSerializationConfigurationBase
    {
        ...
        {
            typeof(T).ToJsonSerializationConfigurationType(),
        };
    }
}
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DependencyOnlyJsonSerializationConfiguration{T1,T2,T3}.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.Serialization.Json
{
    ...
    /// <summary>
    /// A JSON serialization configuration that populates <see cref="DependentJsonSerializationConfigurationTypes"/> with typeof(<typeparamref name="T1"/>), typeof(<typeparamref name="T2"/>), and typeof(<typeparamref name="T3"/>).
    /// </summary>
    ...
    public sealed class DependencyOnlyJsonSerializationConfiguration<T1, T2, T3> : JsonSerializationConfigurationBase

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DependencyOnlyBsonSerializationConfiguration{T1,T2,T3,T4}.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.Serialization.Bson
{
    ...
    /// <summary>
    /// A BSON serialization configuration that populates <see cref="DependentBsonSerializationConfigurationTypes"/> with typeof(<typeparamref name="T1"/>), typeof(<typeparamref name="T2"/>), typeof(<typeparamref name="T3"/>), and typeof(<typeparamref name="T4"/>).
    /// </summary>
    ...
    /// <typeparam name="T4">The fourth dependent BSON serialization configuration type.</typeparam>
    ...
    public sealed class DependencyOnlyBsonSerializationConfiguration<T1, T2, T3, T4> : BsonSerializationConfigurationBase
        ...
        where T4 : BsonSerializationConfigurationBase
    {
        /// <inheritdoc />
        protected override IReadOnlyCollection<BsonSerializationConfigurationType> DependentBsonSerializationConfigurationTypes => new[]
        {
            ...
            typeof(T4).ToBsonSerializationConfigurationType(),
        };
    }
}
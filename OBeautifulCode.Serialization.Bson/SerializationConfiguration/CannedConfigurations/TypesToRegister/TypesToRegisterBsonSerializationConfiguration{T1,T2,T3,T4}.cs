// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TypesToRegisterBsonSerializationConfiguration{T1,T2,T3,T4}.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.Serialization.Bson
{
    ...
    /// <summary>
    /// A BSON serialization configuration that adds <typeparamref name="T1"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, and <typeparamref name="T4"/> to <see cref="TypesToRegisterForBson"/>, using default behavior for <see cref="MemberTypesToInclude"/> and <see cref="RelatedTypesToInclude"/>.
    /// </summary>
    ...
    public sealed class TypesToRegisterBsonSerializationConfiguration<T1, T2, T3, T4> : BsonSerializationConfigurationBase
    {
        /// <inheritdoc />
        protected override IReadOnlyCollection<TypeToRegisterForBson> TypesToRegisterForBson => new[]
        {
            ...
            typeof(T4).ToTypeToRegisterForBson(),
        };

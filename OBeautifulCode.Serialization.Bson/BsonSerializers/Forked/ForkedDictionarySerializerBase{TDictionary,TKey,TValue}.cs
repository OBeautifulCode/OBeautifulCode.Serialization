// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ForkedDictionarySerializerBase{TDictionary,TKey,TValue}.cs" company="OBeautifulCode">
//   Copyright (c) OBeautifulCode 2018. All rights reserved.
// </copyright>
// <auto-generated>
//   Forked from MongoDB.Bson project.  Removed unused constructors and modified the one we need to default
//   to BsonSerializer.SerializerRegistry in the absence of a key or value serializer, independently.
// </auto-generated>
// --------------------------------------------------------------------------------------------------------------------
...
namespace OBeautifulCode.Serialization.Bson
{
    ...
    public abstract class ForkedDictionarySerializerBase<TDictionary, TKey, TValue> :
        ...
        where TDictionary : class, IDictionary<TKey, TValue>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ForkedDictionarySerializerBase{TDictionary,TKey,TValue}" /> class.
        /// </summary>
        /// <param name="dictionaryRepresentation">The dictionary representation.</param>
        /// <param name="keySerializer">The key serializer.</param>
        /// <param name="valueSerializer">The value serializer.</param>
        public ForkedDictionarySerializerBase(
            ...
            : this(
                ...
                keySerializer != null ? new Lazy<IBsonSerializer<TKey>>(() => keySerializer) : new Lazy<IBsonSerializer<TKey>>(() => BsonSerializer.SerializerRegistry.GetSerializer<TKey>()),
                valueSerializer != null ? new Lazy<IBsonSerializer<TValue>>(() => valueSerializer) : new Lazy<IBsonSerializer<TValue>>(() => BsonSerializer.SerializerRegistry.GetSerializer<TValue>()))
        {
        }

        private ForkedDictionarySerializerBase(
            DictionaryRepresentation dictionaryRepresentation,

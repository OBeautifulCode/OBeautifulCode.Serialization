// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IncludeVersionlessAssemblyQualifiedNamePropertyBagSerializationConfiguration{T}.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.Serialization.PropertyBag
{
    ...
    /// sets <see cref="IncludeVersionlessAssemblyQualifiedNameAsProperty"/> to true,
    ...
    public sealed class IncludeVersionlessAssemblyQualifiedNamePropertyBagSerializationConfiguration<T> : PropertyBagSerializationConfigurationBase
